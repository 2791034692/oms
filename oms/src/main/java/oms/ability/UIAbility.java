...
public class UIAbility extends AppCompatActivity implements Ability {
    ...
    protected final void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(ModAbility.baseContext == null){
            ModAbility.baseContext = getApplicationContext();
        }
    ...
    public void setContentView(UIView view) {
        super.setContentView(view.getView());
    }
    @Override
